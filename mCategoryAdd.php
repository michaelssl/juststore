          ...
          <?php 
            if(isset($_POST['add'])){
              ...
              if(strlen($nama_category) < 3){
                ...
                //masukan ke database
                $insert = $conn->query("INSERT INTO category (name_category,image_category,
                date_update_category)VALUES('$nama_category','$image_file','$time')");
                
                if($insert){
                  echo "<script>alert('Category berhasil di tambahkan');</script>";
