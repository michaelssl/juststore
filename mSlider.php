...
<div class="container">
  <nav class="navbar navbar-light">
    <a class="navbar-brand h1" href="#">Slider</a>
    <a href="mslideradd.php" class="btn btn-success ml-2  mr-auto">+ Add</a>
...
<?php 
    //configure
    $table=$conn->query("SELECT * FROM slider");
...
<!-- end pagination -->
  ...
  <tbody>
    <!-- ngambil data -->
    <?php 
      $result= $conn->query("SELECT * FROM slider ORDER BY sequence_slider LIMIT $start_data,$data_perpage");
